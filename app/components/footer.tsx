    ...
    <footer className="border-t py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold mb-4">Zen Space</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/social" className="text-sm text-muted-foreground hover:text-primary">
                  Social Media
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Zen Space. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
